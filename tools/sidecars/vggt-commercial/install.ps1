# Install VGGT-Commercial launcher into LocalAppData engines.
$ErrorActionPreference = "Stop"
$here = Split-Path -Parent $MyInvocation.MyCommand.Path
$dest = Join-Path $env:LOCALAPPDATA "InstaSplatter\engines\sidecars\vggt-commercial"
...
Write-Host "Copied to $dest — drop commercial weights + ACCEPTED after accepting Meta terms."
