...
GOF surface adapter — Experimental only.

Install under `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/gof/` with a
...
6. Copy to `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/gof/` (or use install.ps1).
