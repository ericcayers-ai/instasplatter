# dust3r (Experimental / NC)

See [../research/README.md](../research/README.md).

Copy to `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/dust3r/` and wire your local checkpoint.
...
6. Copy to `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/dust3r/` (or use install.ps1).
