# rade-gs (Experimental)

**License:** research/NC
**Tasks:** surface_mesh

RaDe-GS surface adapter.

Install under `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/rade-gs/` with a
...
6. Copy to `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/rade-gs/` (or use install.ps1).
