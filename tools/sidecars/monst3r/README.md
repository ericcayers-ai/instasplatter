...
Install under `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/monst3r/` with a
...
6. Copy to `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/monst3r/` (or use install.ps1).
