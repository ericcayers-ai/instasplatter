...
$dest = Join-Path $env:LOCALAPPDATA "InstaSplatter\engines\sidecars\mast3r-slam"
...
Write-Host "Copied mast3r-slam adapter to $dest (still .stub until upstream+weights)."
