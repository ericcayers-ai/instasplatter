...
MILo surface/mesh adapter.

Install under `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/milo/` with a
...
6. Copy to `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/milo/` (or use install.ps1).
