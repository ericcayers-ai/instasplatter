...
$dest = Join-Path $env:LOCALAPPDATA "InstaSplatter\engines\sidecars\horizon-gs"
...
Write-Host "Copied horizon-gs adapter to $dest (still .stub until upstream+weights)."
