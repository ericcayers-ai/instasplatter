# city-gaussian (Experimental)

**License:** research/NC
**Tasks:** large_scene

CityGaussian V2 partition / LOD. Engine-specific outputs.

Install under `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/city-gaussian/` with a
...
6. Copy to `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/city-gaussian/` (or use install.ps1).
