...
$dest = Join-Path $env:LOCALAPPDATA "InstaSplatter\engines\sidecars\city-gaussian"
...
Write-Host "Copied city-gaussian adapter to $dest (still .stub until upstream+weights)."
