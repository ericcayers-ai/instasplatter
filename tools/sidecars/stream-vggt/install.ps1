...
$dest = Join-Path $env:LOCALAPPDATA "InstaSplatter\engines\sidecars\stream-vggt"
...
Write-Host "Copied stream-vggt adapter to $dest (still .stub until upstream+weights)."
