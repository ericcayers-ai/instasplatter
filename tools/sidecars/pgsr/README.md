...
PGSR surface adapter — separate product path.

Install under `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/pgsr/` with a
...
6. Copy to `%LOCALAPPDATA%/InstaSplatter/engines/sidecars/pgsr/` (or use install.ps1).
