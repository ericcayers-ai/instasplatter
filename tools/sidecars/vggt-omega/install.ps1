...
$dest = Join-Path $env:LOCALAPPDATA "InstaSplatter\engines\sidecars\vggt-omega"
...
Write-Host "Copied vggt-omega adapter to $dest (still .stub until upstream+weights)."
